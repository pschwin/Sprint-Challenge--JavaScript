...
lowerCase = zooAnimals.map(function(lowercase){
...
populationTotal = zooAnimals.reduce(function(pop, currentPop){
    return pop + currentPop.population;
}, 0);
